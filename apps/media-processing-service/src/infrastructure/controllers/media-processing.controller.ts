  ...
  async handleReelMediaJob(
    ...
    try {
      const result = await this.processReelUseCase.execute({
        ...
        hlsMasterKey: job.hlsMasterKey,
        existingSourceOrientation: job.existingSourceOrientation,
        existingSourceLengthClass: job.existingSourceLengthClass,
        preservedSourceDurationMs: job.preservedSourceDurationMs,
